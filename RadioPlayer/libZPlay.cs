...
namespace libZPlay
{
    ...
    public struct TID3Picture
   {
    ...
    public class ZPlay
    {
        ...
        private extern static int zplay_DrawFFTGraphOnHDC(uint objptr, IntPtr hdc, int nX, int nY, int nWidth, int nHeight);

        [DllImport("libzplay.dll", EntryPoint = "zplay_DrawFFTGraphOnHWND", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
        private extern static int zplay_DrawFFTGraphOnHWND(uint objptr, IntPtr hwnd, int nX, int nY, int nWidth, int nHeight);
        ...
        [DllImport("libzplay.dll", EntryPoint = "zplay_LoadID3ExW", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
        ...
        [DllImport("libzplay.dll", EntryPoint = "zplay_GetWaveOutInfoW", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
        ...
        [DllImport("libzplay.dll", EntryPoint = "zplay_GetStreamInfoW", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
	    ...
	    public bool PlayLoop(TTimeFormat TimeFormatStart, ref TStreamTime StartPosition, TTimeFormat TimeFormatEnd, ref TStreamTime EndPosition, uint NumberOfCycles, bool ContinuePlaying)
        {
            ...
            return zplay_PlayLoop(objptr, Convert.ToInt32((int)(TimeFormatStart)), ref StartPosition, Convert.ToInt32((int)(TimeFormatEnd)), ref EndPosition, NumberOfCycles, continueplay) == 1;
        }
        ...
        {
            TID3Info_Internal tmp = new TID3Info_Internal();
            if (zplay_LoadFileID3W(objptr, FileName, Convert.ToInt32(Format), Convert.ToInt32((int)(Id3Version)), ref tmp) == 1)
            {
                Info.Album = Marshal.PtrToStringUni(tmp.Album);
                Info.Artist = Marshal.PtrToStringUni(tmp.Artist);
                Info.Comment = Marshal.PtrToStringUni(tmp.Comment);
        ...
        {
            return zplay_GetFFTData(objptr, FFTPoints, Convert.ToInt32((int)(FFTWindow)), ref HarmonicNumber, HarmonicFreq, LeftAmplitude, RightAmplitude, LeftPhase, RightPhase) == 1;
        }
